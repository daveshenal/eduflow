...
const durations: Duration[] = [
  { value: '5', label: '5 Minutes', description: 'Quick, focused learning', wordCount: '~625-750 words', icon: '⚡' },
  { value: '10', label: '10 Minutes', description: 'Comprehensive coverage', wordCount: '~1,250-1,500 words', icon: '📚', recommended: true },
  { value: '15', label: '15 Minutes', description: 'In-depth exploration', wordCount: '~1,875-2,250 words', icon: '🎓', locked: true },
];
